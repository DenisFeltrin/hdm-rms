...
public class TestClassTableWIdget extends Showcase {
	...
	private Label resLabelText = new Label(
	...
	private ReservationServiceAsync reservationAdministration = GWT
	...
	public void loadAllReservationsByHostId(int temp_user_id) {
		...
		reservationAdministration
				.loadAllReservationsAsList(new AsyncCallback<ArrayList<ReservationListObj>>() {
					@Override
					public void onFailure(Throwable caught) {
						Window.alert("fehler");
		...
		reservationAdministration
				.loadAllReservationsAsList(new AsyncCallback<ArrayList<ReservationListObj>>() {
					...
					public void onSuccess(ArrayList<ReservationListObj> result) {
						...
						// Add a selection model to handle user selection.
						final SingleSelectionModel<ReservationListObj> selectionModel2 = new SingleSelectionModel<ReservationListObj>();
						...
						new SelectionChangeEvent.Handler() {
							public void onSelectionChange(
									SelectionChangeEvent event) {
								final ReservationListObj selected = selectionModel2
										.getSelectedObject();
								if (selected != null) {
