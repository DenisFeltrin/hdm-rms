...
public class ReportPanel extends VerticalPanel {
	 ...
	 *	 <p>Der zugehörige Button löst einen Klickhandler aus, der die ausgewählten Parameter verarbeitet. Er erstellt
	 *   entweder eine Auflistung mit Datum auf- oder absteigend.
	 */
	public class createReportOne extends Showcase {
		...
		private final Button createReportOneBtnDateAufsteigend = new Button("Übersicht nach Datum aufsteigend");
		private final Button createReportOneBtnDateAbsteigend = new Button("Übersicht nach Datum absteigend");
...
//		private String selectedNickname2;
		...
		public void run() {
			...
			createReportOneBtnDateAbsteigend.addClickHandler(new ClickHandler(){
				...
				public void onClick(ClickEvent event) {
					...
					HTMLReportWriter reportOneToHTMLDatumAbsteigend = new HTMLReportWriter();
					reportOneToHTMLDatumAbsteigend.getHeaderOfReportOneAbsteigend(selectedNickname, selectedRoomId, dateStringStart, dateStringEnd);
					
				}
				
			});
			
			createReportOneBtnDateAufsteigend.addClickHandler(new ClickHandler(){
				...
				public void onClick(ClickEvent event) {
					...
					HTMLReportWriter reportOneToHTMLDatumAbsteigend = new HTMLReportWriter();
					reportOneToHTMLDatumAbsteigend.getHeaderOfReportOneAufsteigend(selectedNickname, selectedRoomId, dateStringStart, dateStringEnd);
		...
		public createReportOne() {
			...
			ButtonPanel.add(createReportOneBtnDateAbsteigend);
			ButtonPanel.add(createReportOneBtnDateAufsteigend);
	...
	public class createReportTwo extends Showcase {
		...
		private final Button createReportTwoBtnDateAbsteigend = new Button("Übersicht nach Datum absteigend");
		private final Button createReportTwoBtnDateAufsteigend = new Button("Übersicht nach Datum aufsteigend");
		...
		public void run() {
			...
			InteractionPanel.getElement().setAttribute("cellpadding", "5");
			InteractionPanel.addStyleName("ReportPanel");
			createReportTwoBtnDateAufsteigend.addStyleName("ReportBtn");
			createReportTwoBtnDateAufsteigend.addStyleName("ReportBtn");
			HeadlineLabel.addStyleName("headline");
			DescriptionLabel.addStyleName("description");
			
			createReportTwoBtnDateAbsteigend.addClickHandler(new ClickHandler(){
				...
				public void onClick(ClickEvent event) {
					...
					HTMLReportWriter reportTwoToHTMLDatumAbsteigend = new HTMLReportWriter();
					reportTwoToHTMLDatumAbsteigend.getHeaderOfReportOneAbsteigend(selectedNickname, selectedUserID, dateStringStart, dateStringEnd);
					
				}
				
			});
			
			createReportTwoBtnDateAufsteigend.addClickHandler(new ClickHandler(){
				...
				public void onClick(ClickEvent event) {
					...
					HTMLReportWriter reportTwoToHTMLDatumAufsteigend = new HTMLReportWriter();
					reportTwoToHTMLDatumAufsteigend.getHeaderOfReportOneAufsteigend(selectedNickname, selectedUserID, dateStringStart, dateStringEnd);
		...
		public createReportTwo() {
			...
			ButtonPanel.add(createReportTwoBtnDateAbsteigend);
			ButtonPanel.add(createReportTwoBtnDateAufsteigend);
			InteractionPanel.add(ButtonPanel);
