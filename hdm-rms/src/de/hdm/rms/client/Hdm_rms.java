 ...
 * @version 1.0
 */
public class Hdm_rms extends Widget implements ClickHandler   {
	...
	/**
	 * Der Konstruktor dieser Klasse fügt die GUI zusammen und weißt den Buttons entsprechende ClickHandler zu.
	 */
	public Hdm_rms() {
