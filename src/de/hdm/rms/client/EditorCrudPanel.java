				...
				sendReservationBtn.addClickHandler(new ClickHandler() {
					public void onClick(ClickEvent event) {
						...
						//	   Window.alert(fmt.format(dateTest));
							   ...
							   String dateStringStart = DateTimeFormat.getFormat("yyyy-MM-dd HH:mm:ss").format(dateStartTime);
							   String dateStringEnd = DateTimeFormat.getFormat("yyyy-MM-dd HH:mm:ss").format(dateEndTime);
